...
## 12) Service de autenticação e hashing de senha

Você pode usar BCrypt.Net-Next para hash (adicionar pacote) ou usar PasswordHasher\<TUser> do Identity. Vou sugerir BCrypt:

```bash
dotnet add package BCrypt.Net-Next
```

`Services/AuthService.cs (esquema):`
